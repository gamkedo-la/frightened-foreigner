...
public class camMouseLook : MonoBehaviour
{
	...
	private void OnEnable( )
	{
		...
		mouselook.y = transform.localEulerAngles.x > 180 ? 360 - transform.localEulerAngles.x : -transform.localEulerAngles.x;
	}
	...
	void Update()
    {
        ...
        if (!GamePaused && !InventoryScript.inventoryActive && !puzzleJumper.activeInHierarchy && !lockViewScript.locked)
        {
